...
int InitWindow ( HINSTANCE hInstance, int show )
{
    ...
    g_hWnd = CreateWindowEx( NULL, L"MY_WINDOWS_CLASS", L"SPH sampling", WS_OVERLAPPEDWINDOW, 0, 0, window_width, window_height, NULL, NULL, hInstance, NULL );
    if( g_hWnd == NULL )
        return E_FAIL;
